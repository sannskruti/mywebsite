  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className="font-bold">5 years</span> of professional experience. I
        enjoy building, deploying and maintaining{" "}
        <span className="italic">websites & apps</span>. My focus is{" "}
        <span className="underline"> Application Development</span> and{" "}
        <span className="underline"> Site Reliabiltiy Engineering</span>
      </motion.h1>
